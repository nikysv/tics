...
const Indexar = () => {
  ...
  return (
    <div className="p-6">
      <Routes>
        {/* Si la URL es "/indexar/documento/:titulo", mostrar VistaDocumento */}
        <Route path="documento/:titulo" element={<VistaDocumento />} />

        {/* Si la URL es exactamente "/indexar", mostrar la pantalla normal */}
        <Route
          path="/"
          element={
            <>
